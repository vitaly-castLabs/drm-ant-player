...
class MediaManager {
  ...
  */
  ...
  isCameraPermissionError(error) {
    ...
    var name = error.name || "";
    return name == "NotAllowedError" || name == "NotFoundError" || name == "NotReadableError" || name == "OverconstrainedError" || name == "SecurityError";
  }
...
export { MediaManager as M, _defineProperty as _, _classPrivateMethodInitSpec as a, _classPrivateFieldInitSpec as b, _asyncToGenerator as c, _classPrivateFieldSet as d, _classPrivateFieldGet as e, _classPrivateMethodGet as f };
